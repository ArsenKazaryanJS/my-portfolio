          ...
          <div className="contact-info">
            ...
            <div className="info-box">
              <div className="info-item">
                <div className="info-icon"><i className="icon-location"></i></div>
              ...
              <div className="info-item">
                <div className="info-icon"><i className="icon-mail"></i></div>
                <div className="info-content">
              ...
              <div className="info-item">
                <div className="info-icon"><i className="icon-phone"></i></div>
                <div className="info-content">
            ...
            <div className="social-links">
              <a href="https://github.com/ArsenKazaryanJS" className="social-link"><Github /></a>
              <a href="https://api.whatsapp.com/send/?phone=98789827" className="social-link"><Phone /></a>
              <a href="https://www.linkedin.com/in/arsen-ghazaryan-b878a22a8/" className="social-link"><Linkedin /></a>
              <a href="https://t.me/ArsenFlare" className="social-link"><Send /></a>
            </div>
          </div>
